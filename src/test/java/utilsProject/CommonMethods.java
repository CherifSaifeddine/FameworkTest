...
public class CommonMethods extends PageInitializer {
	...
	public static void acceptAlert() {
		try {
			Alert alert = wdDriver.switchTo().alert();
			alert.accept();
	...
	public static void switchToFrame(String nameOrId) {
		try {
			wdDriver.switchTo().frame(nameOrId);
	...
	public static void switchToChildWindow() {
		String mainWindow = wdDriver.getWindowHandle();
		Set<String> windows = wdDriver.getWindowHandles();

		for (String window : windows) {
			if (!window.equals(mainWindow)) {
				wdDriver.switchTo().window(window);
			}
		}
	...
	public static WebDriverWait getWaitObject() {
		WebDriverWait wait = new WebDriverWait(wdDriver, Constants.EXPLICIT_WAIT_TIME);
	...
	public static JavascriptExecutor getJSObject() {
		JavascriptExecutor js = (JavascriptExecutor) wdDriver;
	...
	public static byte[] takeScreenshot(String filename) {
		TakesScreenshot ts = (TakesScreenshot) wdDriver;
